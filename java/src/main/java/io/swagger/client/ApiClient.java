...
public class ApiClient {
    ...
    private String basePath = "https://dev-virtserver.swaggerhub.com/qa1Org_A/SHUB-3853/1.0.0";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://dev-virtserver.swaggerhub.com/qa1Org_A/SHUB-3853/1.0.0
